...
public interface DbConstants extends BaseConstant { 
    ...
    public static final String TIMESLOT_G = "G";
    public static final String TIMESLOT_H = "H";
    public static final String TIMESLOT_I = "I";
    public static final String TIMESLOT_K = "K";
